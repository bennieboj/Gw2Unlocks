...
namespace Gw2Unlocks.WikiGraph.Cache;
internal sealed class Gw2WikiGraphJsonCache(CachePaths cachePaths) : GenericCache(cachePaths, "wiki-graph"), IGw2WikiGraphCache
{
