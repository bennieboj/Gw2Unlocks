...
namespace Gw2Unlocks.WikiGraph.IntegrationTests;

public class Gw2WikiSourceTests : ServiceProviderBasedTest<IGw2WikiGraphSource>
{
    ...
    {
        fakeWikiApi = (Gw2WikiIntegrationTestSuccessResponseFake)GetService<IGw2WikiSource>();
    }
    ...
    protected override void Configure(IServiceCollection services)
    {
        services.AddWikiGraphSource()
                ...
                .AddSingleton<IGw2WikiSource>(sp => sp.GetRequiredService<Gw2WikiIntegrationTestSuccessResponseFake>());
    }
    [Fact]
    ...
    public async Task ContainedInShouldRecurseToVendor()
    {
        ...
        Assert.Contains(graph.Edges, e => e.From == containerDungeon && e.To == containerArah && e.Type == EdgeType.Contains);
        Assert.Contains(graph.Edges, e => e.From == containerArah && e.To == item && e.Type == EdgeType.Contains);
    }
