...
{
    public static IServiceCollection AddApiSource(this IServiceCollection services)
    {
        services.AddSingleton<IGw2ApiSource, Gw2Api>()
                .AddGw2Client();
        return services;
    }

    private static IHttpClientBuilder AddGw2Client(this IServiceCollection services)
    {
